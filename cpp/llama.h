...
#include "ggml-cuda.h"
#define LLAMA_MAX_DEVICES LM_GGML_CUDA_MAX_DEVICES
#else
...
#if defined(LM_GGML_USE_CUBLAS) || defined(LM_GGML_USE_CLBLAST) || defined(LM_GGML_USE_METAL) || defined(LM_GGML_USE_KOMPUTE)
